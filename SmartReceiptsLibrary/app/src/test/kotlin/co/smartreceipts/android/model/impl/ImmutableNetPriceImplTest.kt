...
class ImmutableNetPriceImplTest {
    companion object {
    ...
    private lateinit var sameCurrencyPrice: ImmutableNetPriceImpl
    private lateinit var differentCurrenciesNoExchangeRatePrice: ImmutableNetPriceImpl
    ...
    fun setUp() {
        ...
        sameCurrencyPrice = ImmutableNetPriceImpl(USD_CURRENCY, Arrays.asList(usd1, usd2))
        differentCurrenciesNoExchangeRatePrice =
                ImmutableNetPriceImpl(USD_CURRENCY, Arrays.asList(eur1, usd2))
        differentCurrenciesWithExchangeRatePrice =
                ImmutableNetPriceImpl(USD_CURRENCY, Arrays.asList(eurToUsd1, usd2))
    }
    ...
    fun parcel() {
        ...
        val parcelPrice1 = ImmutableNetPriceImpl.CREATOR.createFromParcel(parcel1)
        ...
        val parcelPrice2 = ImmutableNetPriceImpl.CREATOR.createFromParcel(parcel2)
        ...
        val parcelPrice3 = ImmutableNetPriceImpl.CREATOR.createFromParcel(parcel3)
